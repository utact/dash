...
erDiagram
    ...
    Study ||--o{ StudyMission : "manages"
    StudyMission ||--o{ StudyMissionSubmission : "tracks"
    User ||--o{ StudyMissionSubmission : "submits"
    User ||--o{ TutorConversation : "chats"
    User ||--o| LearningPathCache : "caches"
    
    Study {
        Long id PK
        String name "스터디 이름"
        String visibility "PUBLIC/PRIVATE"
        Integer acornCount "도토리 재화"
        String activeMissionTitle "현재 미션"
        datetime createdAt
    }
    ...
    User {
        ...
        String defenseType "랜덤 디펜스 타입"
        String examType "모의고사 타입"
    }
    ...
    AlgorithmRecord {
        ...
        String title
        String code
        String tag "MISSION/MOCK_EXAM/DEFENSE/GENERAL"
    ...
    StudyMission {
        ...
        Integer week "주차"
        String title "미션 제목"
        String problemIds "JSON 배열"
        String sourceType "AI_RECOMMENDED/MANUAL"
        Date deadline
        String status "IN_PROGRESS/COMPLETED"
    }

    StudyMissionSubmission {
        Long id PK
        Long missionId FK
        Long userId FK
        Integer problemId
        Boolean completed
        Boolean isSos "SOS 요청 여부"
    ...
    TutorConversation {
        ...
        String problemNumber "관련 문제"
        datetime createdAt
    }

    LearningPathCache {
        Long id PK
        Long userId FK "UNIQUE"
        String analysisJson "LearningDashboardResponse JSON"
        Date generatedAt "생성 날짜"
    }

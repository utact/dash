...
### 1. 랜딩 페이지 (Landing)
- **경로**: `/`
- **파일**: `src/views/landing/LandingView.vue`
...
### 3. 대시보드 (Dashboard)
- **경로**: `/dashboard`
- **파일**: `src/views/dashboard/DashboardView.vue`
- **기능**:
    - 사용자 환영 메시지 및 프로필 요약.
...
### 5. 랜덤 디펜스 (Defense)
- **경로**: `/defense`
- **파일**: `src/views/defense/DefenseView.vue`
- **기능**:
...
### 6. 모의고사 (Mock Exam)
- **경로**: `/mockexam`
- **파일**: `src/views/mockexam/MockExamView.vue`
- **기능**:
...
#### 7.1 스터디 분석 (Analysis)
- **경로**: `/study/analysis`
- **파일**: `src/views/study/StudyAnalysisView.vue`
- **기능**: 팀원별 실력 분석, 레이더 차트, AI 기반 커리큘럼 추천.

#### 7.2 스터디 미션 (Missions)
- **경로**: `/study/missions`
- **파일**: `src/views/study/StudyMissionView.vue`
- **기능**: 주차별 미션 목록, 문제별 제출 현황 대시보드, SOS 요청.

#### 7.3 스터디 랭킹/목록 (List)
- **경로**: `/study/ranking`
- **파일**: `src/views/study/StudyListView.vue`
...
#### 8.1 게시글 목록 (List)
- **경로**: `/boards`
- **파일**: `src/views/board/BoardList.vue`
- **기능**: 게시글 목록, 검색, 글쓰기 진입.

#### 8.2 게시글 상세 (Detail)
- **경로**: `/boards/:id`
- **파일**: `src/views/board/BoardDetail.vue`
- **기능**: 게시글 내용, 댓글(라인 리뷰 포함), 좋아요.

#### 8.3 게시글 작성/수정 (Form)
- **경로**: `/boards/write`, `/boards/edit/:id`
- **파일**: `src/views/board/BoardForm.vue`
- **기능**: Markdown 에디터, 알고리즘 풀이 코드 첨부.

### 9. 프로필 (Profile)
- **경로**: `/profile`
- **파일**: `src/views/user/ProfileView.vue`
- **기능**: 사용자 정보 조회/수정, Solved.ac 연동 관리, 회원 탈퇴.

### 10. YouTube 검색
- **경로**: `/youtube`
- **파일**: `src/views/utils/YouTubeSearch.vue`
